    ...
    <footer className="bg-slate-900 border-t border-white/10 text-white mt-auto relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 py-12 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {/* Brand */}
          <div>
            <img src="/logo-light.svg" alt="Kalaah Studio" className="h-12 mb-4" />
            <p className="text-gray-400 mb-4 text-sm leading-relaxed">
              Your destination for premium fashion and lifestyle products. Quality meets
              affordability in the modern era.
            </p>
            <div className="flex gap-3">
              <a
                href="#"
                className="w-10 h-10 glass rounded-lg flex items-center justify-center hover:bg-red-600 transition hover:scale-105"
              >
                <Instagram size={18} />
              </a>
              <a
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-400">
              <li>
                <Link to="/products?category=men-tshirts" className="hover:text-red-500 transition">
                  Men's Tees
                </Link>
              </li>
              <li>
                <Link
                  to="/products?category=women-tshirts"
              ...
              <li>
                <Link to="/products?category=hoodies" className="hover:text-red-500 transition">
                  Hoodies
                </Link>
              </li>
              <li>
                <Link to="/products?category=joggers" className="hover:text-red-500 transition">
                  Joggers
                </Link>
              </li>
              <li>
                <Link to="/products?category=accessories" className="hover:text-red-500 transition">
                  Accessories
                </Link>
              </li>
            </ul>
