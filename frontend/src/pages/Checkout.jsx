  ...
  useEffect(() => {
    (async () => {
      try {
        ...
        const first = methods.includes('card')
          ? 'card'
          : methods.includes('google_pay')
            ? 'google_pay'
            : methods.includes('phonepe')
              ? 'phonepe'
              : methods.includes('paytm_wallet')
                ? 'paytm_wallet'
                  ...
                  {(paymentConfig?.allowedMethods || []).map(methodKey => {
                    if (methodKey === 'cod') {
                      ...
                      return (
                        <label
                          key="cod"
                          className={`relative flex items-start gap-4 p-4 border-2 rounded-xl cursor-pointer transition ${
                            paymentMethod === 'cod'
                        ...
                        >
                          ...
                          <div className="flex items-center gap-3 flex-1">
                            <div
                              className={`w-12 h-12 bg-gradient-to-br ${METHOD_CONFIG.cod.gradient} rounded-lg flex items-center justify-center shrink-0`}
                            >
                              <IndianRupee className="text-white" size={22} />
                            </div>
                            <div className="flex-1">
                              <p className="font-semibold text-gray-800">
                                {METHOD_CONFIG.cod.label}
                              </p>
                        ...
                        >
                          ...
                          <div className="flex items-center gap-3 flex-1">
                            {isGPay ? (
                              ...
                              <div
                                className={`w-12 h-12 bg-gradient-to-br ${cfg.gradient} rounded-lg flex items-center justify-center shrink-0`}
                              >
                        ...
                        {isGPay && paymentMethod === 'google_pay' && (
                          <div className="gpay-sheet animate-slide-down">
                            ...
                            <div className="gpay-sheet-header">
                              ...
                              <p className="gpay-sheet-sub">
                                Pay fast & securely with your preferred UPI app
                              </p>
                            </div>
                            ...
                            <div className="gpay-items-preview">
                              <div className="gpay-items-title">
                                ...
                                {cart.items.slice(0, 3).map((item, i) => (
                                  <div key={i} className="gpay-item">
                                    <img
                                      ...
                                      alt=""
                                      className="gpay-item-img"
                                    />
                                    <div className="gpay-item-info">
                                      <div className="gpay-item-name">{item.product?.name}</div>
                                      <div className="gpay-item-meta">
                                        {item.quantity} × {item.size}
                                      </div>
                                    </div>
                                    <div className="gpay-item-price">
                                      {formatPrice(item.price * item.quantity)}
                                    </div>
                                  </div>
                                ))}
                                {cart.items.length > 3 && (
                                  <div className="gpay-item-more">
                              ...
                              {loading ? (
                                ...
                                <>
                                  <svg viewBox="0 0 272 92" className="gpay-btn-logo" fill="white">
                                    ...
                                    <path
                                      d="M33 34h-6v8h-8v6h8v8h6v-8h8v-6h-8v-8z"
                                      fill="#4285F4"
                                    />
                                  </svg>
