...
async function autoSeed() {
  ...
  const brandDefs = [
    {
      name: 'Urban Style',
      slug: 'urban-style',
      description: 'Modern streetwear for the bold',
      isActive: true,
    },
    {
      name: 'Classic Wear',
      slug: 'classic-wear',
      description: 'Timeless fashion essentials',
      isActive: true,
    },
    {
      name: 'Sport Elite',
  ...
  const productDefs = [
    // MEN'S T-SHIRTS
    {
      ...
      description:
        'Premium 100% cotton white t-shirt perfect for everyday wear. Soft, breathable, and effortlessly stylish.',
      price: 499,
      salePrice: 399,
    ...
    },
    {
      ...
      description:
        'Bold graphic print t-shirt with unique artwork. Make a statement wherever you go.',
      price: 799,
      salePrice: 599,
      category: 'men-tshirts',
      isFeatured: true,
    ...
    },
    {
      ...
      description:
        'Classic striped polo shirt for a refined casual look. Perfect for office or weekend outings.',
      price: 999,
      salePrice: 799,
      category: 'men-tshirts',
      isFeatured: false,
    ...
    },
    {
      ...
      description:
        'Trendy oversized drop-shoulder tee. Relaxed silhouette with premium heavy jersey fabric.',
      price: 699,
      salePrice: 549,
      category: 'men-tshirts',
      isFeatured: true,
    ...
    },
    {
      ...
      description:
        'Retro-inspired washed tee with a lived-in feel. Soft, pre-washed fabric for instant comfort.',
      price: 649,
      salePrice: 499,
      category: 'men-tshirts',
      isFeatured: false,
      ...
      colors: [{ name: 'Washed Blue', hex: '#6CA0DC' }],
      images: [{ url: 'https://images.unsplash.com/photo-1583743814966-8936f5b7be1a?w=600&q=80' }],
      rating: { average: 4.4, count: 95 },
      tags: ['vintage', 'washed', 'retro'],
      bi: 0,
    },
    {
      name: 'Henley Neck T-Shirt',
      description:
        'Sophisticated henley neck design with buttoned placket. Elevated take on the casual tee.',
      price: 849,
      salePrice: 699,
      category: 'men-tshirts',
      isFeatured: false,
    ...
    },
    {
      ...
      description:
        'Clean slim-fit V-neck tee in premium cotton stretch. Perfect layering piece or standalone.',
      price: 549,
      salePrice: null,
      category: 'men-tshirts',
      isFeatured: false,
      ...
      rating: { average: 4.0, count: 52 },
      tags: ['slim-fit', 'v-neck'],
      bi: 2,
    },
    {
      name: 'Athletic Performance Tee',
      description:
        'Moisture-wicking performance tee for active lifestyles. Lightweight, breathable, anti-odour.',
      price: 999,
      salePrice: 799,
      category: 'men-tshirts',
      isFeatured: false,
    ...
    // WOMEN'S T-SHIRTS
    {
      ...
      description:
        'Beautiful floral print t-shirt for women. Relaxed fit with ultra-soft breathable fabric.',
      price: 599,
      salePrice: 449,
    ...
    },
    {
      ...
      description: 'Essential women t-shirt in soft pastel colors. The perfect everyday basic.',
      price: 449,
      salePrice: 349,
      category: 'women-tshirts',
      isFeatured: false,
      ...
      tags: ['women', 'basic', 'pastel'],
      bi: 1,
    },
    {
      name: 'Cropped Logo Tee',
      description:
        'Trendy cropped tee with minimalist chest logo. Pair with high-waist jeans or skirts.',
      price: 549,
      salePrice: 429,
      category: 'women-tshirts',
      isFeatured: true,
      ...
      tags: ['cropped', 'logo', 'trendy'],
      bi: 0,
    },
    {
      name: 'Women Oversized Tee',
      description:
        'Effortlessly chic oversized tee for women. Boyfriend-fit silhouette with dropped shoulders.',
      price: 649,
      salePrice: 499,
      category: 'women-tshirts',
      isFeatured: false,
    ...
    },
    {
      ...
      tags: ['women', 'striped', 'nautical'],
      bi: 1,
    },
    {
      name: 'Tie-Dye Festival Tee',
      description: 'Vibrant tie-dye tee for a festival-ready look. Each piece uniquely patterned.',
      price: 799,
      salePrice: 599,
      category: 'women-tshirts',
      isFeatured: true,
      ...
      rating: { average: 4.8, count: 225 },
      tags: ['tie-dye', 'festival'],
      bi: 0,
    },
    // HOODIES
    {
      name: 'Oversized Hoodie',
      description: 'Super comfortable oversized hoodie. Premium fleece interior, drawstring hood.',
      price: 1499,
      salePrice: 1199,
      category: 'hoodies',
      isFeatured: true,
      ...
      colors: [{ name: 'Grey Marl', hex: '#B0B0B0' }],
    ...
    },
    {
      ...
      description:
        'Ultra-warm pullover hoodie with thick fleece lining. Your best cold-day companion.',
      price: 1899,
      salePrice: 1499,
      category: 'hoodies',
      isFeatured: true,
      ...
      rating: { average: 4.8, count: 275 },
      tags: ['fleece', 'pullover', 'warm'],
      bi: 0,
    },
    {
      name: 'Graphic Hoodie',
      description: 'Statement graphic hoodie with bold chest print. Street style ready.',
      price: 1599,
      salePrice: 1299,
      category: 'hoodies',
      isFeatured: false,
      ...
      tags: ['graphic', 'hoodie', 'streetwear'],
      bi: 0,
    },
    {
      name: 'Quarter Zip Sweatshirt',
      description: 'Classic quarter-zip sweatshirt for a smart-casual look.',
      price: 1399,
      salePrice: null,
      category: 'hoodies',
      isFeatured: false,
      ...
      tags: ['quarter-zip', 'sweatshirt'],
      bi: 1,
    },
    {
      name: 'Cropped Hoodie',
      description: 'Trendy cropped hoodie for women. Pairs perfectly with high-waist joggers.',
      price: 1299,
      salePrice: 999,
      category: 'hoodies',
      isFeatured: false,
    ...
    // JOGGERS
    {
      ...
      description:
        'Ultra-soft joggers with elastic waistband and tapered fit. Perfect for workout or lounging.',
      price: 999,
      salePrice: 799,
      category: 'joggers',
      isFeatured: true,
    ...
    },
    {
      ...
      description:
        'Stylish slim fit joggers for the modern look. Tapered design with ribbed cuffs.',
      price: 1199,
      salePrice: 999,
      category: 'joggers',
      isFeatured: false,
      ...
      rating: { average: 4.3, count: 121 },
      tags: ['slim-fit', 'joggers'],
      bi: 3,
    },
    {
      name: 'Cargo Joggers',
      description: 'Functional cargo joggers with multiple pockets. Style meets utility.',
      price: 1499,
      salePrice: 1199,
      category: 'joggers',
      isFeatured: true,
    ...
    },
    {
      name: 'Track Pants',
      description:
        'Classic track pants with contrast side stripes. Lightweight, perfect for sport or casual wear.',
      price: 1099,
      salePrice: 899,
      category: 'joggers',
      isFeatured: false,
      ...
      rating: { average: 4.2, count: 97 },
      tags: ['track-pants', 'sport'],
      bi: 2,
    },
    {
      name: 'Fleece Sweatpants',
      description: 'Thick fleece sweatpants for maximum warmth. Lounge in ultimate cozy style.',
      price: 1299,
      salePrice: 999,
      category: 'joggers',
      isFeatured: false,
    ...
    // ACCESSORIES
    {
      ...
      rating: { average: 4.3, count: 152 },
      tags: ['cap', 'snapback'],
      bi: 0,
    },
    {
      name: 'Minimalist Backpack',
      description: 'Sleek minimalist backpack with laptop compartment. 25L, water-resistant.',
      price: 1999,
      salePrice: 1599,
      category: 'accessories',
      isFeatured: true,
    ...
    },
    {
      ...
      description: 'Pack of 6 premium cotton socks. Cushioned sole for all-day comfort.',
      price: 299,
      salePrice: 199,
      category: 'accessories',
      isFeatured: false,
    ...
    },
    {
      ...
      description: 'Eco-friendly heavy canvas tote bag. Carry your essentials sustainably.',
      price: 599,
      salePrice: 449,
      category: 'accessories',
      isFeatured: false,
    ...
    },
    {
      ...
      description: 'Spacious sports duffel with wet-dry compartment. Perfect for gym or travel.',
      price: 1799,
      salePrice: 1399,
      category: 'accessories',
      isFeatured: true,
      ...
      tags: ['duffel', 'gym', 'sports'],
      bi: 2,
    },
    {
      name: 'Beanie Hat',
      description: 'Soft ribbed knit beanie. One size fits most. Unisex design.',
      price: 349,
      salePrice: 249,
      category: 'accessories',
      isFeatured: false,
      ...
      rating: { average: 4.5, count: 204 },
      tags: ['beanie', 'hat', 'winter'],
      bi: 1,
    },
    {
      name: 'Woven Belt',
      description: 'Stylish woven belt with brushed metal buckle. Fits waist 28–38 inches.',
      price: 399,
      salePrice: 299,
      category: 'accessories',
      isFeatured: false,
  ...
  await Coupon.insertMany([
    ...
    {
      code: 'SAVE20',
      description: '20% off up to ₹500 on orders above ₹499',
      discountType: 'percentage',
      discountValue: 20,
      minOrderValue: 499,
      maxDiscount: 500,
  ...
  console.log(
    `✅ Auto-seed complete: ${createdBrands.length} brands, ${productsWithMeta.length} products, 3 coupons`,
  );
}
// ────────────────────────────────────────────────────────────────────────────
